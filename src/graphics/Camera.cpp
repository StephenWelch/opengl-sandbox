...
Camera::Camera(float fieldOfViewDegrees, float screenWidth,
							 float screenHeight) {
...
void Camera::setMinViewDistance(float minViewDist) {
	this->minViewDist = minViewDist;
}

float Camera::getMaxViewDistance() const { return maxViewDist; }

void Camera::setMaxViewDistance(float maxViewDist) {
